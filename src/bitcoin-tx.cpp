...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bebacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bebacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bebacoin transaction") + "\n" +
              "  bebacoin-tx [options] -create [commands]   " + _("Create hex-encoded bebacoin transaction") + "\n" +
              "\n";
