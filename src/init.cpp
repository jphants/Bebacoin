...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bebacoin-project/bebacoin>";
    const std::string URL_WEBSITE = "<https://bebacoin.org>";
