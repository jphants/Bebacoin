...
{
    const char* pszTimestamp = "Bebacoin2025";
    const CScript genesisOutputScript = CScript() << ParseHex("151584710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("34.45.55.216", "34.45.55.216", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("bebacointools.com", "dnsseed.bebacointools.com"));
        //vSeeds.push_back(CDNSSeedData("bebacoinpool.org", "dnsseed.bebacoinpool.org"));
        ...
        chainTxData = ChainTxData{
            ...
            1718496000, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("34.45.55.216", "34.45.55.216", true));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.bebacoin.loshan.co.uk", true));
