...
const char * const BITCOIN_CONF_FILENAME = "bebacoin.conf";
const char * const BITCOIN_PID_FILENAME = "bebacoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bebacoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bebacoin";
#else
    // Unix
    return pathRet / ".bebacoin";
#endif
#endif
}
